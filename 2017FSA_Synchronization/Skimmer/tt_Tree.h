...
float e_1, px_1, py_1, pz_1, pt_1, phi_1, eta_1, m_1, q_1, d0_1, dZ_1, mt_1, iso_1, iso_1_old, iso_1_new, t1_decayMode;
float e_2, px_2, py_2, pz_2, pt_2, phi_2, eta_2, m_2, q_2, d0_2, dZ_2, mt_2, iso_2, iso_2_old, iso_2_new, t2_decayMode;
float pfmt_1, puppimt_1,trigweight_1,idisoweight_1,pfmt_2,puppimt_2,trigweight_2,midisoweight_2,pt_tt,m_vis,m_sv,mt_sv,puppimet,puppimetphi,pfpzetamiss,puppipzetamiss,puweight,idisoweight_2;
...
float t1RerunMVArun2v2DBoldDMwLTVVLoose, t1RerunMVArun2v2DBoldDMwLTVLoose, t1RerunMVArun2v2DBoldDMwLTLoose, t1RerunMVArun2v2DBoldDMwLTMedium, t1RerunMVArun2v2DBoldDMwLTTight, t1RerunMVArun2v2DBoldDMwLTVTight, t1RerunMVArun2v2DBoldDMwLTVVTight, t1RerunMVArun2v2DBoldDMwLTraw;
float t2RerunMVArun2v2DBoldDMwLTVVLoose, t2RerunMVArun2v2DBoldDMwLTVLoose, t2RerunMVArun2v2DBoldDMwLTLoose, t2RerunMVArun2v2DBoldDMwLTMedium, t2RerunMVArun2v2DBoldDMwLTTight, t2RerunMVArun2v2DBoldDMwLTVTight, t2RerunMVArun2v2DBoldDMwLTVVTight, t2RerunMVArun2v2DBoldDMwLTraw;
int trg_doubletau; 

RecoilCorrector recoilPFMetCorrector("Type1_PFMET_2017.root");  // For local test
//RecoilCorrector recoilPFMetCorrector("TypeI-PFMet_Run2016BtoH.root");

void fillTree(TTree *Run_Tree, HTauTauTree_tt *tree, int entry_tree, int recoil, bool ismc, bool isembed, bool seventeen){
	...
	&& tree->t2MatchesDoubleTightTau40Path && tree->t2MatchesDoubleTightTau40Filter;
      if (!tight35 && !medium40 && !tight40) trg_doubletau=0;
    }
    ...
    t1RerunMVArun2v2DBoldDMwLTraw = tree->t1RerunMVArun2v2DBoldDMwLTraw;
    ...
    t2RerunMVArun2v2DBoldDMwLTraw = tree->t2RerunMVArun2v2DBoldDMwLTraw;
    ...
    if (isembed && tree->t1DecayMode==0) tau1=tau1*0.975;
    else if (isembed && tree->t1DecayMode==1) tau1=tau1*0.975*1.051;
    else if (isembed && tree->t1DecayMode==10) tau1=tau1*(0.975*0.975*0.975)*(1.0);
    if (isembed && tree->t2DecayMode==0) tau2=tau2*0.975;
    else if (isembed && tree->t2DecayMode==1) tau2=tau2*0.975*1.051;
    else if (isembed && tree->t2DecayMode==10) tau2=tau2*(0.975*0.975*0.975)*(1.0);
    ...
    */
    ...
    mt_1 = sqrt(2*tau1.Pt()*mymet.Pt()*(1-std::cos(tau1.DeltaPhi(mymet))));//tree->t1MtToPfMet_type1; // FIXME
    q_1 = tree->t1Charge;
    ...
    mt_2 = sqrt(2*tau2.Pt()*mymet.Pt()*(1-std::cos(tau2.DeltaPhi(mymet))));//tree->t1MtToPfMet_type1; // FIXME
    q_2 = tree->t2Charge;
   ...
   if (njetspt20 > 1){
     jdeta=fabs(jet1.Eta()-jet2.Eta());//tree->vbfDeta;
     jdphi=jet1.DeltaPhi(jet2);//tree->vbfDphi;
     dijetpt=dijet.Pt();
     dijetphi=dijet.Phi();
