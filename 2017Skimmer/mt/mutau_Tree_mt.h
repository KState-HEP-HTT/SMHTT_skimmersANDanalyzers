...
float e_2, px_2, py_2, pz_2, pt_2, phi_2, eta_2, m_2, q_2, d0_2, dZ_2, mt_2, iso_2, iso_2_old, iso_2_new, l2_decayMode;
...
float mMatchesIsoMu27Path, mMatchesIsoMu27Filter,IsoMu27Pass;
RecoilCorrector recoilPFMetCorrector("Type1_PFMET_2017.root");
...
void fillTree(TTree *Run_Tree, HTauTauTree_mt *tree, int entry_tree, int recoil, bool ismc, bool seventeen) {
    ...
    if (seventeen) { // cross trigger only
      ...
      mMatchesIsoMu24Path=tree->mMatchesIsoMu24Path;
      mMatchesIsoMu24Filter=tree->mMatchesIsoMu24Filter;
      IsoMu24Pass=tree->IsoMu24Pass;
      mMatchesIsoMu27Path=tree->mMatchesIsoMu27Path;
      mMatchesIsoMu27Filter=tree->mMatchesIsoMu27Filter;
      IsoMu27Pass=tree->IsoMu27Pass;      
    }
    else {
    ...
    dZ_2 = tree->tPVDZ;
    d0_2=tree->tPVDXY;
    iso_2_old=tree->tByIsolationMVArun2v1DBoldDMwLTraw;
    iso_2_new=tree->tByIsolationMVArun2v1DBnewDMwLTraw;
    q_2 = tree->tCharge;
