...
int main(int argc, char** argv) {
    ...
    */
    ...
    std::vector<TH1F*> h1_AI_FakeFraction_2D;
    ...
    for (int k=0; k<nbhist; ++k){
      ...
      h2_WOS.push_back(new TH1F (HNS2WOS.str().c_str(),"InvMa",binnum_mjj,bins_mjj)); h2_WOS[k]->Sumw2();
        ...
        h0_AI_FakeFraction_2D.push_back(new TH1F (HNSh0_AI_FakeFraction_2D.str().c_str(),"FakeJet_0jet",binnum_mjj,bins_mjj)); h0_AI_FakeFraction_2D[k]->Sumw2();
        
        //FakeFactor  boosted FF
        ostringstream HNSh1_AI_FakeFraction_2D; HNSh1_AI_FakeFraction_2D << "h1_AI_FakeFraction_2D" << k;
        h1_AI_FakeFraction_2D.push_back(new TH1F (HNSh1_AI_FakeFraction_2D.str().c_str(),"FakeJet_boosted",binnum_mjj,bins_mjj)); h1_AI_FakeFraction_2D[k]->Sumw2();
        
        //FakeFactor  vbf FF
        ostringstream HNSh2_AI_FakeFraction_2D; HNSh2_AI_FakeFraction_2D << "h2_AI_FakeFraction_2D" << k;
        h2_AI_FakeFraction_2D.push_back(new TH1F (HNSh2_AI_FakeFraction_2D.str().c_str(),"FakeJet_vbf",binnum_mjj,bins_mjj)); h2_AI_FakeFraction_2D[k]->Sumw2();
...
//      if (sample!="embedded" && !isSingleLep && !isCrossTrigger) continue;
	...
	sf_id_anti=myScaleFactor_idAnti->get_ScaleFactor(pt_1,eta_1);
        ...
        cout >>"antiisoRegion = "<<antiisoRegion<<"\n";
      ...
      float qcdCR=(byTightIsolationMVArun2v1DBoldDMwLT_2 && iso_1<0.30 && iso_1>0.15);
        // FakeFactor FF Here you have to define the antu-isolated region
