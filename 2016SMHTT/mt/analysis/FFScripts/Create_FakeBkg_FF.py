if __name__ == "__main__":
    ...
    parser.add_argument('--scale', default="nominal_FF", choices=['nominal', 'up', 'down', 'wup', 'wdown','qcdup','qcddown','JESup','JESdown','allJES'], help="Which TES?")
    ...
    fzj=ROOT.TFile("files_"+options.scale+"/ZJ.root","r")
    fzl=ROOT.TFile("files_"+options.scale+"/ZL.root","r")
    ...
    fData=ROOT.TFile("files_nominal_FF/Data.root","r")
	...
	if options.scale=="nominal":
	   ...
	   postfixData=postfixFF[k]
        ...
        h_0jet.Add(fVV.Get("AI0jet_FF/VV"+postfix),-1)
        ...
        h_boosted.Add(fVV.Get("AIboosted_FF/VV"+postfix),-1)
        ...
        h_vbf.Add(fVV.Get("AIvbf_FF/VV"+postfix),-1)
