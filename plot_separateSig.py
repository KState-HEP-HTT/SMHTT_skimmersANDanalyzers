...
for i in range (0,ncat):
   ...
   ggH.SetLineColor(ROOT.kRed)
   ggH.SetLineStyle(7)
   ggH.SetMarkerStyle(0) 
   ggH.SetLineWidth(4)

   VBF.SetLineColor(ROOT.kOrange+7)
   VBF.SetLineStyle(7)
   VBF.SetMarkerStyle(0) 
   VBF.SetLineWidth(4)

   WH.SetLineColor(ROOT.kBlue)
   WH.SetLineStyle(7)
   WH.SetMarkerStyle(0) 
   WH.SetLineWidth(4)

   ZH.SetLineColor(ROOT.kGreen)
   ZH.SetLineStyle(7)
   ZH.SetMarkerStyle(0) 
   ZH.SetLineWidth(4)
